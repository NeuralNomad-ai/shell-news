...
When ratings files are present:
1. Combine all ratings into a single dataset
2. Items scored 4–5 → surface similar topic/source/type content more prominently
3. Items scored 1–2 → downweight similar content; check if category is preferred at lower frequency
4. Re-rank today's items with highest-affinity items first within each section
